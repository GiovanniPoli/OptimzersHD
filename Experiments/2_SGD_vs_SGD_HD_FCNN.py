...
SGDfc ={'0.1'     : {'HD':{'loss':[], 'val_loss':[],'alpha_it':[],'alpha_epoch':[], 'loss_it':[], 'val_acc':[0.0]},
...
for i in ('0.1','0.01','0.001','0.0001','0.00001','0.000001'):
    ...
    optm_HD = MyOpts.SGD_HD(alpha_0 = alpha_test, beta= 1e-5)
    ...
    SGDfc[i]['HD']['alpha_epoch'].append(float(i))
    SGDfc[i]['HD']['loss'].append(start_loss_train)
    SGDfc[i]['HD']['val_loss'].append(start_loss_val)
    ...
    print('\nSGD-HD, alpha_0='+i+', beta= 10^6 (MNIST).')
    for epoch in range(EPOCHS):
      t0 = time.time() 
      alphas_means = 0
      for (x_train, y_train) in train_dataset:
        train_step(model, optm_HD, x_train, y_train)
        SGDfc[i]['HD']['alpha_it'].append(optm_HD._get_alpha().numpy())
      ...
      SGDfc[i]['HD']['alpha_epoch'].append(alphas_means/iter_for_epoch)
      SGDfc[i]['HD']['loss'].append(train_loss.result().numpy()*1)
      SGDfc[i]['HD']['val_loss'].append(test_loss.result().numpy()*1)
      SGDfc[i]['HD']['val_acc'].append(test_accuracy.result().numpy()*1)
    ...
    SGDfc[i]['HD']['loss_it'] = SGDfc[i]['HD']['loss_it']  + iteration_loss
    
    SGDfc[i]['Keras']['loss'].append(start_loss_train)
    SGDfc[i]['Keras']['val_loss'].append(start_loss_val)
    ...
    for epoch in range(EPOCHS):
      ...
      SGDfc[i]['Keras']['loss'].append(train_loss.result().numpy()*1)
      SGDfc[i]['Keras']['val_loss'].append(test_loss.result().numpy()*1)
      SGDfc[i]['Keras']['val_acc'].append(test_accuracy.result().numpy()*1)
    ...
    SGDfc[i]['Keras']['loss_it'] = SGDfc[i]['Keras']['loss_it']  + iteration_loss
 
## Extra moltiplicative

SGDfc['0.1']['HD Multiplicative']={'loss':[], 'val_loss':[],'alpha_it':[],'alpha_epoch':[], 'loss_it':[], 'val_acc':[0.0]}
...
SGDfc['0.1']['HD Multiplicative']['alpha_epoch'].append(0.1)
SGDfc['0.1']['HD Multiplicative']['loss'].append(start_loss_train)
SGDfc['0.1']['HD Multiplicative']['val_loss'].append(start_loss_val)
...
for epoch in range(EPOCHS):
      ...
      for (x_train, y_train) in train_dataset:
        train_step(model, optm_HD, x_train, y_train)
        SGDfc['0.1']['HD Multiplicative']['alpha_it'].append(optm_HD._get_alpha().numpy())
        alphas_means += optm_HD._get_alpha().numpy()
      ...
      SGDfc['0.1']['HD Multiplicative']['alpha_epoch'].append(alphas_means/iter_for_epoch)
      SGDfc['0.1']['HD Multiplicative']['loss'].append(train_loss.result().numpy()*1)
      SGDfc['0.1']['HD Multiplicative']['val_loss'].append(test_loss.result().numpy()*1)
      SGDfc['0.1']['HD Multiplicative']['val_acc'].append(test_accuracy.result().numpy()*1)
...
SGDfc['0.1']['HD Multiplicative']['loss_it'] = SGDfc['0.1']['HD Multiplicative']['loss_it']  + iteration_loss

save_result(SGDfc, 'Output_Alpha_impact_SGDvsSGD_HD_FCNN')
...
plt.plot(SGDfc['0.1']['HD Multiplicative']['alpha_epoch'],
             color='black', label=r'SGDM HD $\alpha_0=10^{-1}$') 
count = 0
for i in list(SGDfc.keys()):
    plt.plot(SGDfc[i]['HD']['alpha_epoch'],
...
plt.plot(range(1, EPOCHS*iter_for_epoch + 1), SGDfc['0.1']['HD Multiplicative']['alpha_it'],
             color='black', label=r'SGDM HD $\alpha_0=10^{-1}$')
count = 0
for i in list(SGDfc.keys()):
    plt.plot(range(1, EPOCHS*iter_for_epoch + 1), SGDfc[i]['HD']['alpha_it'],
             color=cols[count], linestyle='-',  label=labsHD[count])
...
plt.plot(SGDfc['0.1']['HD Multiplicative']['loss'],
             color='black', label=r'SGDM HD $\alpha_0=10^{-1}$')
count = 0
for i in list(SGDfc.keys()):
    plt.plot(SGDfc[i]['HD']['loss'],
             color=cols[count], linestyle='-',  label=labsHD[count])
    plt.plot(SGDfc[i]['Keras']['loss'],
             color=lcols[count], linestyle='--',  label=labs[count])
    count += 1
plt.yscale('log')
...
plt.plot(range(1, EPOCHS*iter_for_epoch + 1), SGDfc['0.1']['HD Multiplicative']['loss_it'],
             color='black', label=r'SGDM HD $\alpha_0=10^{-1}$')
count = 0
for i in list(SGDfc.keys()):
    plt.plot(range(1, EPOCHS*iter_for_epoch + 1), SGDfc[i]['HD']['loss_it'],
             color=cols[count], linestyle='-',  label=labsHD[count])
    plt.plot(range(1, EPOCHS*iter_for_epoch + 1), SGDfc[i]['Keras']['loss_it'],
             color=lcols[count], linestyle='--',  label=labs[count])
    count += 1
plt.xlabel('Iteration')
plt.ylabel('Train loss')
...
plt.plot(SGDfc['0.1']['HD Multiplicative']['val_loss'],
             color='black', label=r'SGDM HD $\alpha_0=0.02$') 
count = 0
for i in list(SGDfc.keys()):
