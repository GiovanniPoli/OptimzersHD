...
optm = keras.optimizers.Adam(lr = 0.001, beta_1 = 0.9, beta_2=0.999,
                         epsilon = 1e-8)
...
for epoch in range(EPOCHS):
      ...
      VGG_Net['Adam']['Keras']['loss'].append(train_loss.result().numpy()*1)
      VGG_Net['Adam']['Keras']['val_loss'].append(test_loss.result().numpy()*1)
      VGG_Net['Adam']['Keras']['val_acc'].append(test_accuracy.result().numpy()*1)
...
VGG_Net['Adam']['Keras']['loss_it'] = VGG_Net['Adam']['Keras']['loss_it']  + iteration_loss
...
plt.plot(VGG_Net['Adam']['Keras']['val_loss'],
