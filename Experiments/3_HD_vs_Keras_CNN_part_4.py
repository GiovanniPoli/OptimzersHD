...
optm = keras.optimizers.SGD(lr = 0.001, momentum=0, nesterov=False)
            

VGG_Net['SGD']['Keras']['loss'].append(start_loss_train)
VGG_Net['SGD']['Keras']['val_loss'].append(start_loss_val)
...
for epoch in range(EPOCHS):
      ...
      VGG_Net['SGD']['Keras']['loss'].append(train_loss.result().numpy()*1)
      VGG_Net['SGD']['Keras']['val_loss'].append(test_loss.result().numpy()*1)
      VGG_Net['SGD']['Keras']['val_acc'].append(test_accuracy.result().numpy()*1)
...
VGG_Net['SGD']['Keras']['loss_it'] = VGG_Net['SGD']['Keras']['loss_it']  + iteration_loss

save_result(VGG_Net,"VGG_performances_result_final")
model.save_weights('SGD_final.h5')
...
plt.plot(VGG_Net['SGD']['Keras']['loss'], linestyle='-', color='tab:purple')
plt.xlabel('Epoch')
plt.yscale('log')
plt.grid()
...
plt.plot(VGG_Net['SGD']['Keras']['val_loss'],
